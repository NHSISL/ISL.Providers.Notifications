...
namespace ISL.Providers.Notifications.GovukNotify.Tests.Unit.Services.Foundations.Notifications
{
    public partial class NotificationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnSendEmailWithTemplateId(
            Exception dependancyValidationException)
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnSendEmailWithTemplateId(Exception dependancyException)
        {
            // given
            string inputToEmail = GetRandomEmailAddress();
            string inputSubject = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnSendEmailWithTemplateId()
        {
            // given
            string inputToEmail = GetRandomEmailAddress();
            string inputSubject = GetRandomString();
